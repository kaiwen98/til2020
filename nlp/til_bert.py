...
from keras.layers import add, Dropout, PReLU, BatchNormalization, GlobalMaxPooling1D, Bidirectional, LSTM
...
s_model_file = 'model_rnn.json'
model_file = 'model_rnn.json'
s_weights_file = 'model_rnn.h5'
weights_file = 'model_rnn.h5'
...
def _save_model(model):
    ...
    with open(s_model_file, 'w') as json_file:
...
def classifier(model, emb_mean, emb_std, embeddings_index):
    ...
    for train, test in kfold.split(x_train, y_train):
        ...
        es = EarlyStopping(monitor = 'val_loss', verbose = 1, patience = 10, restore_best_weights = True, mode = 'min')
