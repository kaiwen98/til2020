...
s_model_file = 'model_cv.json'
model_file = 'model_cv.json'
s_weights_file = 'model_original.h5'
weights_file = 'model_original.h5'
...
def classifier(model_name, emb_mean, emb_std, embeddings_index):
    ...
    num_folds = 2
    num = 0
    kfold = KFold(n_splits=num_folds, shuffle=True, random_state = 223)
...
if __name__ == "__main__":
    ...
    while(start<5):
        ...
        model_name = 'original_ensemble_dpcnn_0'
    ...
    while(start<5):
        ...
        model = 'original_ensemble_dpcnn_0'
        model = classifier(model,emb_mean, emb_std, embeddings_index)
        #_save_model(model)
        start = start + 1
